...
export function CardRefeicao({ refeicao }) {
  ...
  return (
    <motion.div
      ...
      className="overflow-hidden rounded-xl bg-[#EF5170]"
    >
      <button
        type="button"
        onClick={toggle}
        className="w-full grid grid-cols-[auto_1fr] items-center gap-4 px-4 py-4 text-left"
      >
        {refeicao.imagem ? (
          <img
            src={refeicao.imagem}
          ...
          <div className="w-9 h-9 rounded-full bg-[#E6E6E6]" />
        )}
        <span className="text-white text-[17px] font-semibold leading-none">
          {refeicao.nome}
        </span>
      </button>
        ...
        {isOpen && (
          ...
          >
            <div className="px-4 pt-3 pb-4">
              ...
              <div className="grid grid-cols-[1fr_76px_28px] items-center px-1 mb-1">
                <span className="text-white text-[14px] font-medium">Categoria</span>
